...
/* This calculates partial derivatives of various quantities
   involved in calculating the derivatives of the dynamical quantities
   T9, h, and phie.
 */
